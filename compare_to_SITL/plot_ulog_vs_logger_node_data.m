...
[file_name,parent_dir] = uigetfile([getenv('HOME'), '/Masters/Developer/MATLAB/Quad_Sim_Murray/system_id/SITL/honeybee_payload/data/*.csv'], message);
...
[file_name,parent_dir] = uigetfile([getenv('HOME'), '/Masters/Developer/MATLAB/Quad_Sim_Murray/compare_to_SITL/*.csv'], message);
