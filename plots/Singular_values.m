...
csv_filename = [getenv('HOME'), '/Masters/Thesis/', chapter, '/csv/', 'Singular_values_', sim_type, '_', simulation_data_file, '_', algorithm, payload_angle_str, T_train_str, hyper_str '.csv'];
csv_filename
...
%% Truncated
csv_filename_trunc = [getenv('HOME'), '/Masters/Thesis/', chapter, '/csv/', 'Singular_values_', sim_type, '_', simulation_data_file, '_', algorithm, payload_angle_str, T_train_str, hyper_str, '_trunc', '.csv'];
