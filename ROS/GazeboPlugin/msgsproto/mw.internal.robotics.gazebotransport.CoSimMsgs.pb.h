...
const PacketHeader_MsgID PacketHeader_MsgID_MsgID_MAX = PacketHeader_MsgID_GET_GAZEBO_MODEL_PARAM;
...
class Packet : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mw.internal.robotics.gazebotransport.Packet) */ {
 public:
  ...
  // optional string error_message = 42;
  bool has_error_message() const;
  void clear_error_message();
  static const int kErrorMessageFieldNumber = 42;
