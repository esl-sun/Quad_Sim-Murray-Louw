...
// Generated 16-Jun-2021 16:08:34
...
namespace ros
{
  namespace matlab
  {
    ...
    class NodeInterface {
      ...
      std::shared_ptr<robotROSGetStartedExample_editModelClass> mModel;
     ...
     public:
      ...
      //
      std::shared_ptr<robotROSGetStartedExample_editModelClass> getModel()
      {
        return mModel;
      }
    };                                 //class NodeInterface
